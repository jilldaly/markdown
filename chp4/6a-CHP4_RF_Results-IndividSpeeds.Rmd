...
```{r baseline-rf-plot, echo=FALSE, fig.cap="Baseline Vibration Model"}
...
```{r plot_mc-roc, echo=FALSE, fig.cap="Baseline Vibration ROC using 4 Binary ROC Curves"}
...
```{r mag-rf-plot, echo=FALSE, fig.cap="Mag Model"}
plot(mag_rf_results$mc_model_rf)
```

```{r mag-rf-params, echo=FALSE, fig.cap="Mag Model Parameters"}
knitr::kable(mag_rf_results$mc_model_rf$results, caption = "Mag RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
mag_rf_results$mc_model_rf$finalModel 
mag_rf_results$mc_model_rf
```

```{r mag-rf-results, echo=FALSE}
knitr::kable(mag_rf_results$rf_accuracy, caption = "Mag RF - Validation Accuracy", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(mag_rf_results$lsm_metrics, caption = "Mag RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(mag_rf_results$lsm_cm, caption = "Mag RF Vaidation Confusion Matrix", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(mag_rf_results$lsm_mlogloss, caption = "Mag RF Vaidation LogLoss", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```

  
```{r plot_mag-roc, echo=FALSE, fig.cap="Mag ROC using 4 Binary ROC Curves"}
res_path_idle <- mag_rf_results$roc_res[[1]]
res_path_moving <- mag_rf_results$roc_res[[2]]
res_path_trans <- mag_rf_results$roc_res[[3]]
res_shuttle <- mag_rf_results$roc_res[[4]]
...
```{r combined-rf-plot, echo=FALSE, fig.cap="Vibration + Magnetometer Model"}
plot(combined_rf_results$mc_model_rf)
```


```{r combined-rf-params, echo=FALSE, fig.cap="Vibration + Magnetometer Model Parameters"}
knitr::kable(combined_rf_results$mc_model_rf$results, caption = "Vibration + Magnetometer RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
combined_rf_results$mc_model_rf$finalModel 
combined_rf_results$mc_model_rf
```


```{r combined-rf-results, echo=FALSE}
knitr::kable(combined_rf_results$rf_accuracy, caption = "Vibration + Magnetometer RF - Validation Accuracy", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(combined_rf_results$lsm_metrics, caption = "Vibration + Magnetometer RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(combined_rf_results$lsm_cm, caption = "Vibration + Magnetometer RF Vaidation Confusion Matrix", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(combined_rf_results$lsm_mlogloss, caption = "Vibration + Magnetometer RF Vaidation LogLoss", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```

  
```{r plot_combined-roc, echo=FALSE, fig.cap="Vibration + Magnetometer ROC using 4 Binary ROC Curves"}
res_path_idle <- combined_rf_results$roc_res[[1]]
res_path_moving <- combined_rf_results$roc_res[[2]]
res_path_trans <- combined_rf_results$roc_res[[3]]
res_shuttle <- combined_rf_results$roc_res[[4]]
...
<!-- There's an issue with the class imbalance for these datasets... need to investigate -->
<!-- s11_a_1_v_0_03 -->
<!-- s11_a_1_v_0_0135 -->
<!-- s11_a_2_v_0_2 -->


<!-- s12_a_1_v_0_4_rf_results -->

```{r a1v004-rf-plot, echo=FALSE, fig.cap="Acc 1 Vel 0.04 Model"}
plot(s12_a_1_v_0_4_rf_results$mc_model_rf)
```

```{r a1v004-rf-params, echo=FALSE, fig.cap="a_1_v_0_04 Model Parameters"}
knitr::kable(s12_a_1_v_0_4_rf_results$mc_model_rf$results, caption = "Acc 1 Vel 0.04 RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
s12_a_1_v_0_4_rf_results$mc_model_rf$finalModel 
s12_a_1_v_0_4_rf_results$mc_model_rf

knitr::kable(s12_a_1_v_0_4_rf_results$rf_accuracy, caption = "Acc 1 Vel 0.04 RF - Validation Accuracy", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(s12_a_1_v_0_4_rf_results$lsm_metrics, caption = "Acc 1 Vel 0.04 RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```


<!-- s12_a_1_v_0_06_rf_results -->

```{r a1v006-rf-plot, echo=FALSE, fig.cap="Acc 1 Vel 0.06 Model"}
plot(s12_a_1_v_0_06_rf_results$mc_model_rf)
```

```{r a1v006-rf-params, echo=FALSE, fig.cap="Acc 1 Vel 0.06 Model Parameters"}
knitr::kable(s12_a_1_v_0_06_rf_results$mc_model_rf$results, caption = "Acc 1 Vel 0.06 RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
s12_a_1_v_0_06_rf_results$mc_model_rf$finalModel 
s12_a_1_v_0_06_rf_results$mc_model_rf

knitr::kable(s12_a_1_v_0_06_rf_results$rf_accuracy, caption = "Acc 1 Vel 0.06 RF - Validation Accuracy", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

knitr::kable(s12_a_1_v_0_06_rf_results$lsm_metrics, caption = "Acc 1 Vel 0.06 RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```



<!-- s12_a_2_v_0_4_rf_results -->

```{r a2v04-rf-plot, echo=FALSE, fig.cap="Acc 2 Vel 0.4 Model"}
plot(s12_a_2_v_0_4_rf_results$mc_model_rf)
```

```{r a2v04-rf-params, echo=FALSE, fig.cap="a2v04 Model Parameters"}
knitr::kable(s12_a_2_v_0_4_rf_results$mc_model_rf$results, caption = "Acc 2 Vel 0.4 - RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
s12_a_2_v_0_4_rf_results$mc_model_rf$finalModel 
s12_a_2_v_0_4_rf_results$mc_model_rf

knitr::kable(s12_a_2_v_0_4_rf_results$rf_accuracy, caption = "Acc 2 Vel 0.4 - RF - Validation Accuracy", booktabs=TRUE)%>%   kable_styling(latex_options=c("hold_position"))

knitr::kable(s12_a_2_v_0_4_rf_results$lsm_metrics, caption = "Acc 2 Vel 0.4 - RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```


<!-- s12_a_2_v_0_06_rf_results -->

```{r a2v006-rf-plot, echo=FALSE, fig.cap="Acc 2 Vel 0.06 Model"}
plot(s12_a_2_v_0_06_rf_results$mc_model_rf)
```

```{r a2v006-rf-params, echo=FALSE, fig.cap="Acc 2 Vel 0.06 Model Parameters"}
knitr::kable(s12_a_2_v_0_06_rf_results$mc_model_rf$results, caption = "Acc 2 Vel 0.06 RF Training Model Results", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))

# print screen
s12_a_2_v_0_06_rf_results$mc_model_rf$finalModel 
s12_a_2_v_0_06_rf_results$mc_model_rf

knitr::kable(s12_a_2_v_0_06_rf_results$rf_accuracy, caption = "Acc 2 Vel 0.06 RF - Validation Accuracy", booktabs=TRUE)%>%   kable_styling(latex_options=c("hold_position"))

knitr::kable(s12_a_2_v_0_06_rf_results$lsm_metrics, caption = "Acc 2 Vel 0.06 RF Validation Metrics", booktabs=TRUE)%>% 
  kable_styling(latex_options=c("hold_position"))
```
